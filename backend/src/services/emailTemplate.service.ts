...
<div class="footer"><p>Construction Management Platform</p></div>
</body></html>
`);
...
<div class="content">
<p>Hello {{firstName}},</p>
<p>You have been invited to join <strong>{{organizationName}}</strong> on the Construction Management Platform.</p>
...
You have been invited to join "{{organizationName}}" on the Construction Management Platform.
